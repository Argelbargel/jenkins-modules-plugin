...
public abstract class CauseActionQueuePredicate<CAUSE extends Cause> extends SingleActionQueuePredicate<CauseAction> {
    private final Class<CAUSE> causeType;
    private final boolean checkUpstream;

    @SuppressWarnings("WeakerAccess") // part of public API
    protected CauseActionQueuePredicate(Class<CAUSE> type, boolean upstream) {
