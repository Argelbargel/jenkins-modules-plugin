...
public class StartedBySameUserPredicateTest {
    ...
    public void testMatchesSameUser() throws Exception {
        ...
        assertTrue(new StartedBySameUserQueuePredicate(false).test(reason, subject));
    }
    ...
    public void testDoesNotMatchDifferentUser() throws Exception {
        ...
        assertFalse(new StartedBySameUserQueuePredicate(false).test(reason, subject));
    }
    ...
    public void testWalksUpstream() throws Exception {
        ...
        StartedBySameUserQueuePredicate underTest = new StartedBySameUserQueuePredicate(true);
