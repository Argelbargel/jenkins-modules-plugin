...
public class UpstreamBuildPredicateTest {
    ...
    public void testMatchesSameUpstreamProject() {
        ...
        assertTrue(new UpstreamBuildQueuePredicate().test(new UpstreamCause(run1), new UpstreamCause(run2)));
    }
    ...
    public void testDoesNotMatchUpstreamProjectWithDifferentNames() {
        ...
        assertFalse(new UpstreamBuildQueuePredicate().test(new UpstreamCause(run1), new UpstreamCause(run2)));
    }
    ...
    public void testWalksUpstreamCauses() {
        ...
        assertTrue(new UpstreamBuildQueuePredicate().test(action1, action2));
        assertTrue(new UpstreamBuildQueuePredicate().test(action2, action1));
    }
}