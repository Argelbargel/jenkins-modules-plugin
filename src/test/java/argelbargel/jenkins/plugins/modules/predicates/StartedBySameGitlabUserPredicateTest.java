...
public class StartedBySameGitlabUserPredicateTest {
    ...
    public void testMatchesCauseTriggeredBySameUser() throws Exception {
        assertTrue(new StartedBySameGitlabUserPredicate(false).test(createGitlabCause("foo"), createGitlabCause("foo")));
    }

    @Test
    public void testDoesNotMatchCauseTriggeredByDifferentUser() throws Exception {
        assertFalse(new StartedBySameGitlabUserPredicate(false).test(createGitlabCause("foo"), createGitlabCause("bar")));
    }
